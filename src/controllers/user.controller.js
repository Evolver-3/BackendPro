...
const updateCoverImage=asyncHandler(async(req,res)=>{
  ...
  if(!cover.url){
    throw new ApiError(500,"Something went wrong whiel uploading coverImage")
...
export {registerUser,loginUser,logoutUser,refreshAccessToken,changeCurrentPassword,getCurrentUser,updateAccountDetails,avatarUpdate,updateCoverImage}